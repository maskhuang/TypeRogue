...
// Story 60.9: keyTooltip 单例（与 classic 商品卡共用）— 退出商店时关掉残留
...
import type { SubmitStage, DrawerKind } from './shop/shopState';
// Story 60.16 Task 2: terminal 模块（cmd / render / descriptors / banner / chrome）
import * as terminal from './shop/shopTerminal';
// Story 60.16 Task 3: workbench 模块（sync / drawer / drag / inbox card）
...
// attachWorkbenchTooltips 测试在 shopPreviewTooltip.test.ts 用 — 从 workbench re-export
