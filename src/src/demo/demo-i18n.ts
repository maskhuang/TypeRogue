...
const ZH: Record<string, string> = {
  ...
  'affix_desc.resonance': '范围内匹配技能触发时叠层，每叠N层自触发一次',
  'affix_desc.mirror': '每关结束时从范围内随机复制一个邻居词条，下关替代自身生效',
  'affix_desc.splash': '自身不产出；每叠N层触发范围内1个匹配技能',
  'affix_desc.amplify': '自身不产出；触发叠层，范围内匹配技能产出+自身基础值',
  'affix_desc.conduit': '自身不产出，范围内匹配技能触发时额外触发一次',
  'affix_desc.relay': '自身不产出；范围内匹配技能触发时叠层，每叠N层中转触发1个匹配技能',
  ...
  'affix_desc.war_drum': '自身不产出；触发叠层，范围内匹配技能+暴击率（取决于层数）',
