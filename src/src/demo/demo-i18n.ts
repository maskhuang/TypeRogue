...
const ZH: Record<string, string> = {
  ...
  'affix_desc.resonance': '任意技能产出指定资源时叠层，满层触发自身',
  'affix_desc.echo': '拥有指定两种词条的技能触发时叠层，满层触发自身',
...
const EN: Record<string, string> = {
  ...
  'affix_desc.resonance': 'Stacks when any skill produces specified resource; self-triggers when full',
  'affix_desc.echo': 'Stacks when skills with specified two affix types trigger; self-triggers when full',
