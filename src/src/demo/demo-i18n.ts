...
const ZH: Record<string, string> = {
  ...
  // --- quest enchantments (19 name + 19 effect) ---
  'quest.quest_devour': '吞噬', 'quest.quest_devour.effect': '质变：每次吞噬',
  'quest.quest_overload': '过载', 'quest.quest_overload.effect': '质变：保底暴击',
  'quest.quest_echo': '回响', 'quest.quest_echo.effect': '质变：跨技能脉冲同步',
  'quest.quest_chain': '连锁', 'quest.quest_chain.effect': '质变：双向连锁',
  'quest.quest_purify': '净化', 'quest.quest_purify.effect': '质变：衰减反转为增长',
  'quest.quest_resonance': '共振', 'quest.quest_resonance.effect': '质变：共鸣增强',
  'quest.quest_charge': '蓄势', 'quest.quest_charge.effect': '质变：首尾呼应',
  'quest.quest_refine': '精炼', 'quest.quest_refine.effect': '质变：双向转化',
  'quest.quest_energize': '充能', 'quest.quest_energize.effect': '质变：满蓄力自动完成',
  'quest.quest_fission': '裂变', 'quest.quest_fission.effect': '质变：溅射链一跳',
  'quest.quest_stack': '层叠', 'quest.quest_stack.effect': '质变：换词保留50%层数',
  'quest.quest_polarize': '极化', 'quest.quest_polarize.effect': '质变：双向锁定',
  'quest.quest_spectrum': '光谱', 'quest.quest_spectrum.effect': '质变：全资源产出',
  'quest.quest_mirror': '映射', 'quest.quest_mirror.effect': '质变：全词条复制',
  'quest.quest_overlap': '重叠', 'quest.quest_overlap.effect': '质变：关卡累计计数',
  'quest.quest_iterate': '迭代', 'quest.quest_iterate.effect': '质变：递归不衰减',
  'quest.quest_sacrifice': '献祭', 'quest.quest_sacrifice.effect': '质变：惩罚转为随机资源',
  'quest.quest_twin': '镜像', 'quest.quest_twin.effect': '质变：词条效果加倍',
  'quest.quest_conduit': '导引', 'quest.quest_conduit.effect': '质变：导能 +2',
  ...
  'est.quest_progress': '任务 {stacks}/{target}层',
  'est.quest_completions': '(完成{count}次)',
  ...
  'ench_info.quest_desc': '{effect} ({stacks}次触发)',
...
const EN: Record<string, string> = {
  ...
  // --- quest enchantments (19 name + 19 effect) ---
  'quest.quest_devour': 'Devour', 'quest.quest_devour.effect': 'Transform: devour every trigger',
  'quest.quest_overload': 'Overload', 'quest.quest_overload.effect': 'Transform: guaranteed crit',
  'quest.quest_echo': 'Echo', 'quest.quest_echo.effect': 'Transform: cross-skill pulse sync',
  'quest.quest_chain': 'Chain', 'quest.quest_chain.effect': 'Transform: bidirectional cascade',
  'quest.quest_purify': 'Purify', 'quest.quest_purify.effect': 'Transform: decay reverses to growth',
  'quest.quest_resonance': 'Harmonize', 'quest.quest_resonance.effect': 'Transform: resonance boost +50%',
  'quest.quest_charge': 'Empower', 'quest.quest_charge.effect': 'Transform: first-last echo',
  'quest.quest_refine': 'Refine', 'quest.quest_refine.effect': 'Transform: bidirectional conversion',
  'quest.quest_energize': 'Energize', 'quest.quest_energize.effect': 'Transform: full charge auto-complete',
  'quest.quest_fission': 'Fission', 'quest.quest_fission.effect': 'Transform: splash chains one hop',
  'quest.quest_stack': 'Stack', 'quest.quest_stack.effect': 'Transform: retain 50% stacks on word change',
  'quest.quest_polarize': 'Polarize', 'quest.quest_polarize.effect': 'Transform: dual gravity lock',
  'quest.quest_spectrum': 'Spectrum', 'quest.quest_spectrum.effect': 'Transform: all-resource output',
  'quest.quest_mirror': 'Reflect', 'quest.quest_mirror.effect': 'Transform: copy all neighbor affixes',
  'quest.quest_overlap': 'Overlap', 'quest.quest_overlap.effect': 'Transform: stage cumulative count',
  'quest.quest_iterate': 'Iterate', 'quest.quest_iterate.effect': 'Transform: no recurse decay',
  'quest.quest_sacrifice': 'Sacrifice', 'quest.quest_sacrifice.effect': 'Transform: penalty converts to random resource',
  'quest.quest_twin': 'Mirror', 'quest.quest_twin.effect': 'Transform: double affix effects',
  'quest.quest_conduit': 'Channel', 'quest.quest_conduit.effect': 'Transform: conduit +2 triggers',
  ...
  'est.quest_progress': 'Quest {stacks}/{target} stacks',
  'est.quest_completions': '(done {count}×)',
  ...
  // --- enchantment display info ---
  'ench_info.quest_desc': '{effect} ({stacks} triggers)',
