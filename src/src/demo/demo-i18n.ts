...
const ZH: Record<string, string> = {
  ...
  'shop.ascend': '升华',
  'shop.ascend_name': '{name} → Lv.{level}',
  'shop.ascend_desc': '升华：学徒经验兑换等级突破',
  'shop.ascend_success': '✨ {name} 升华至 Lv.{level}!',
  'shop.ascend_fail': '升华条件不满足',
  ...
  'help.ascend': '升华',
  'help.ascend.desc': '拥有学徒附魔的 Lv.3+ 技能，积累足够经验后可在商店花费金币升华，突破等级上限。',
...
const EN: Record<string, string> = {
  ...
  'shop.ascend': 'Ascend',
  'shop.ascend_name': '{name} → Lv.{level}',
  'shop.ascend_desc': 'Ascend: spend apprentice EXP to break level cap',
  'shop.ascend_success': '✨ {name} ascended to Lv.{level}!',
  'shop.ascend_fail': 'Ascension requirements not met',
  ...
  'help.ascend.desc': 'Lv.3+ skills with apprentice enchantments can ascend in shop after accumulating enough EXP, spending gold to break level cap.',
