...
const ZH: Record<string, string> = {
  ...
  // --- affix names (20) ---
  'affix.multiply': '强化', 'affix.convert': '转化', 'affix.rainbow': '彩虹',
  ...
  'ench_meta.apprentice_word': '学徒·造词',
  'ench_meta.apprentice_word.desc': '完成单词时永久成长 +2%',
  'ench_meta.apprentice_proc': '学徒·悟道',
  'ench_meta.apprentice_proc.desc': '词条特效触发时永久成长 +3%',
  'ench_meta.apprentice_longword': '学徒·长词',
  'ench_meta.apprentice_longword.desc': '完成6+字母单词时永久成长 +5%',
  'ench_meta.apprentice_perfect': '学徒·精准',
  'ench_meta.apprentice_perfect.desc': '零错误完成单词时永久成长 +8%',
  'ench_meta.apprentice_combo': '学徒·连击',
  'ench_meta.apprentice_combo.desc': '连击达15时永久成长 +10%',
  'ench_meta.apprentice_stage': '学徒·通关',
  'ench_meta.apprentice_stage.desc': '通关时永久成长 +15%',
  'ench_meta.apprentice_harvest': '学徒·丰收',
  'ench_meta.apprentice_harvest.desc': '造词师限定：每造一个词永久成长 +15%',
  'ench_meta.apprentice_adapt': '学徒·适应',
  'ench_meta.apprentice_adapt.desc': '蜕变师限定：每次蜕变永久成长 +3%',
  ...
  'quest.quest_ascend': '升华', 'quest.quest_ascend.effect': '强化倍率 +0.15',
  'quest.quest_chain': '连锁', 'quest.quest_chain.effect': '级联倍率 +0.2',
  'quest.quest_purify': '净化', 'quest.quest_purify.effect': '衰减下限 -0.05 (最低 0.1)',
  ...
  'quest.quest_sacrifice': '献祭', 'quest.quest_sacrifice.effect': '惩罚概率 -1%/层 (最低 2%)',
  ...
  'est.multiply': '强化 ×{val}',
  'est.multiply_quest': '({base}+{c}×0.15 任务)',
  'est.void': '虚无 +{pct}%',
...
const EN: Record<string, string> = {
  ...
  // --- affix names (20) ---
  'affix.multiply': 'Enhance', 'affix.convert': 'Convert', 'affix.rainbow': 'Rainbow',
  ...
  'affix.link': 'Link', 'affix.splash': 'Splash', 'affix.amplify': 'Amplify',
  ...
  // --- affix descriptions (20) ---
  'affix_desc.multiply': 'Multiplies output by a factor',
  ...
  'ench_meta.apprentice_word': 'Apprentice·Word',
  'ench_meta.apprentice_word.desc': 'Perma growth +2% on word complete',
  'ench_meta.apprentice_proc': 'Apprentice·Insight',
  'ench_meta.apprentice_proc.desc': 'Perma growth +3% on affix proc',
  'ench_meta.apprentice_longword': 'Apprentice·LongWord',
  'ench_meta.apprentice_longword.desc': 'Perma growth +5% on 6+ letter word',
  'ench_meta.apprentice_perfect': 'Apprentice·Perfect',
  'ench_meta.apprentice_perfect.desc': 'Perma growth +8% on zero-error word',
  'ench_meta.apprentice_combo': 'Apprentice·Combo',
  'ench_meta.apprentice_combo.desc': 'Perma growth +10% at 15 combo',
  'ench_meta.apprentice_stage': 'Apprentice·Clear',
  'ench_meta.apprentice_stage.desc': 'Perma growth +15% on stage clear',
  'ench_meta.apprentice_harvest': 'Apprentice·Harvest',
  'ench_meta.apprentice_harvest.desc': 'Wordsmith only: perma growth +15% per crafted word',
  'ench_meta.apprentice_adapt': 'Apprentice·Adapt',
  'ench_meta.apprentice_adapt.desc': 'Metamorph only: perma growth +3% per mutation',
  ...
  'quest.quest_ascend': 'Ascend', 'quest.quest_ascend.effect': 'Enhance mult +0.15',
  'quest.quest_chain': 'Chain', 'quest.quest_chain.effect': 'Cascade mult +0.2',
  'quest.quest_purify': 'Purify', 'quest.quest_purify.effect': 'Decay floor -0.05 (min 0.1)',
  ...
  'quest.quest_sacrifice': 'Sacrifice', 'quest.quest_sacrifice.effect': 'Penalty chance -1%/stack (min 2%)',
  ...
  'est.multiply': 'Enhance ×{val}',
  'est.multiply_quest': '({base}+{c}×0.15 quest)',
  'est.void': 'Void +{pct}%',
