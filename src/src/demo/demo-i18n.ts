...
const ZH: Record<string, string> = {
  ...
  'quest.quest_overload': '过载', 'quest.quest_overload.effect': '暴击倍率 +0.5',
  'quest.quest_echo': '回响', 'quest.quest_echo.effect': '爆发倍率 +0.3',
  'quest.quest_chain': '连锁', 'quest.quest_chain.effect': '级联倍率 +0.2',
  'quest.quest_purify': '净化', 'quest.quest_purify.effect': '衰减下限 +0.05/层 (衰减更温和)',
  ...
  'quest.quest_fission': '裂变', 'quest.quest_fission.effect': '额外触发 +1 邻居',
  'quest.quest_stack': '层叠', 'quest.quest_stack.effect': '每层加成 +0.005',
  ...
  'quest.quest_overlap': '重叠', 'quest.quest_overlap.effect': '连字有效重复次数 +1/层',
  'quest.quest_iterate': '迭代', 'quest.quest_iterate.effect': '递归概率 +3%/层',
  'quest.quest_sacrifice': '献祭', 'quest.quest_sacrifice.effect': '正面加成 +30%/层',
...
const EN: Record<string, string> = {
  ...
  'quest.quest_overload': 'Overload', 'quest.quest_overload.effect': 'Crit mult +0.5',
  'quest.quest_echo': 'Echo', 'quest.quest_echo.effect': 'Burst mult +0.3',
  'quest.quest_chain': 'Chain', 'quest.quest_chain.effect': 'Cascade mult +0.2',
  'quest.quest_purify': 'Purify', 'quest.quest_purify.effect': 'Decay floor +0.05/stack (softer decay)',
  ...
  'quest.quest_fission': 'Fission', 'quest.quest_fission.effect': 'Extra trigger +1 neighbor',
  'quest.quest_stack': 'Stack', 'quest.quest_stack.effect': 'Per-stack bonus +0.005',
  ...
  'quest.quest_overlap': 'Overlap', 'quest.quest_overlap.effect': 'Ligature effective repeats +1/stack',
  'quest.quest_iterate': 'Iterate', 'quest.quest_iterate.effect': 'Recurse chance +3%/stack',
  'quest.quest_sacrifice': 'Sacrifice', 'quest.quest_sacrifice.effect': 'Bonus +30%/stack',
