...
const ZH: Record<string, string> = {
  ...
  'affix_desc.flow': '指定关系的邻居中比自己强的越多，产出加成越高',
  ...
  'quest.quest_devour': '吞噬', 'quest.quest_devour.effect': '每次触发寻找最弱邻居吞噬', 'quest.quest_devour.task': '范围填满',
  'quest.quest_overload': '过载', 'quest.quest_overload.effect': '暴击必定触发', 'quest.quest_overload.task': '暴击8次',
  'quest.quest_echo': '回响', 'quest.quest_echo.effect': '爆发时触发所有匹配技能', 'quest.quest_echo.task': '脉冲爆发6次',
  'quest.quest_chain': '连锁', 'quest.quest_chain.effect': '级联双向判定，反向键也触发', 'quest.quest_chain.task': '连锁触发6次',
  'quest.quest_purify': '净化', 'quest.quest_purify.effect': '衰减方向反转，越触发越强', 'quest.quest_purify.task': '衰减触底3次',
  'quest.quest_charge': '蓄势', 'quest.quest_charge.effect': '词首/词尾触发时额外触发对端技能', 'quest.quest_charge.task': '流放触发10次',
  'quest.quest_refine': '精炼', 'quest.quest_refine.effect': '转化同时反向产出到源资源', 'quest.quest_refine.task': '触发15次',
  'quest.quest_energize': '充能', 'quest.quest_energize.effect': '满蓄力释放时自动打完当前单词', 'quest.quest_energize.task': '完成5个词',
  'quest.quest_fission': '裂变', 'quest.quest_fission.effect': '溅射目标可再溅射一次', 'quest.quest_fission.task': '溅射触发8次',
  'quest.quest_stack': '层叠', 'quest.quest_stack.effect': '叠层增加时触发匹配技能一次', 'quest.quest_stack.task': '触发25次',
  'quest.quest_polarize': '极化', 'quest.quest_polarize.effect': '吸引字母必含，排斥字母必不含', 'quest.quest_polarize.task': '匹配词8个',
  'quest.quest_spectrum': '光谱', 'quest.quest_spectrum.effect': '产出等比分摊到所有资源', 'quest.quest_spectrum.task': '5资源词3次',
  'quest.quest_mirror': '映射', 'quest.quest_mirror.effect': '复制邻居所有不同类型的词条', 'quest.quest_mirror.task': '通关1次',
  'quest.quest_overlap': '重叠', 'quest.quest_overlap.effect': '连字按关卡累计按键次数计算', 'quest.quest_overlap.task': '触发15次',
  'quest.quest_iterate': '迭代', 'quest.quest_iterate.effect': '暴击重触发时暴击率不再减半', 'quest.quest_iterate.task': '暴击重触发5次',
  'quest.quest_sacrifice': '献祭', 'quest.quest_sacrifice.effect': '未暴击惩罚改为产出到随机其他资源', 'quest.quest_sacrifice.task': '惩罚触发3次',
  'quest.quest_twin': '镜像', 'quest.quest_twin.effect': '所有非双生词条效果翻倍', 'quest.quest_twin.task': '通关3次',
  'quest.quest_conduit': '导引', 'quest.quest_conduit.effect': '为邻居提供2次额外触发', 'quest.quest_conduit.task': '触发15次',
  'quest.quest_relay': '中继', 'quest.quest_relay.effect': '中转时触发所有匹配技能', 'quest.quest_relay.task': '装备N个',
  'quest.quest_multiply_op': '乘算化', 'quest.quest_multiply_op.effect': '产出从加法模式变为乘法模式', 'quest.quest_multiply_op.task': '触发15次',
  // Epic 52: 34 新质变
...
const EN: Record<string, string> = {
  ...
  // --- quest enchantments (19 name + 19 effect + 19 task) ---
  'quest.quest_devour': 'Devour', 'quest.quest_devour.effect': 'Each trigger finds weakest neighbor to devour', 'quest.quest_devour.task': 'Range full',
  'quest.quest_overload': 'Overload', 'quest.quest_overload.effect': 'Crit always triggers', 'quest.quest_overload.task': 'Crit 8 times',
  'quest.quest_echo': 'Echo', 'quest.quest_echo.effect': 'Pulse burst triggers all matched skills', 'quest.quest_echo.task': 'Pulse 6 times',
  'quest.quest_chain': 'Chain', 'quest.quest_chain.effect': 'Cascade checks both directions', 'quest.quest_chain.task': 'Cascade 6 times',
  'quest.quest_purify': 'Purify', 'quest.quest_purify.effect': 'Decay reverses: more triggers = stronger', 'quest.quest_purify.task': 'Hit floor 3 times',
  'quest.quest_charge': 'Empower', 'quest.quest_charge.effect': 'Word start/end triggers the opposite skill', 'quest.quest_charge.task': 'Outcast 10 times',
  'quest.quest_refine': 'Refine', 'quest.quest_refine.effect': 'Conversion also outputs back to source', 'quest.quest_refine.task': 'Trigger 15 times',
  'quest.quest_energize': 'Energize', 'quest.quest_energize.effect': 'Full charge auto-completes current word', 'quest.quest_energize.task': 'Complete 5 words',
  'quest.quest_fission': 'Fission', 'quest.quest_fission.effect': 'Splash target can splash once more', 'quest.quest_fission.task': 'Splash 8 times',
  'quest.quest_stack': 'Stack', 'quest.quest_stack.effect': 'Stacking triggers one matched skill', 'quest.quest_stack.task': 'Trigger 25 times',
  'quest.quest_polarize': 'Polarize', 'quest.quest_polarize.effect': 'Attracted letters guaranteed, repelled excluded', 'quest.quest_polarize.task': '8 matching words',
  'quest.quest_spectrum': 'Spectrum', 'quest.quest_spectrum.effect': 'Output split equally across all resources', 'quest.quest_spectrum.task': '5-resource word 3 times',
  'quest.quest_mirror': 'Reflect', 'quest.quest_mirror.effect': 'Copy all unique affix types from neighbors', 'quest.quest_mirror.task': 'Clear 1 stage',
  'quest.quest_overlap': 'Overlap', 'quest.quest_overlap.effect': 'Ligature counts stage-total keypresses', 'quest.quest_overlap.task': 'Trigger 15 times',
  'quest.quest_iterate': 'Iterate', 'quest.quest_iterate.effect': 'Crit retrigger no longer halves crit rate', 'quest.quest_iterate.task': 'Crit retrigger 5 times',
  'quest.quest_sacrifice': 'Sacrifice', 'quest.quest_sacrifice.effect': 'Miss penalty outputs to random other resource', 'quest.quest_sacrifice.task': 'Penalty 3 times',
  'quest.quest_twin': 'Mirror', 'quest.quest_twin.effect': 'All non-Twin affix effects doubled', 'quest.quest_twin.task': 'Clear 3 stages',
  'quest.quest_conduit': 'Channel', 'quest.quest_conduit.effect': 'Gives neighbors 2 extra triggers', 'quest.quest_conduit.task': 'Trigger 15 times',
  'quest.quest_relay': 'Relay', 'quest.quest_relay.effect': 'Relay triggers all matched skills', 'quest.quest_relay.task': 'Equip N',
  'quest.quest_multiply_op': 'Multiply', 'quest.quest_multiply_op.effect': 'Output switches from additive to multiplicative', 'quest.quest_multiply_op.task': 'Trigger 15 times',
  // Epic 52
