...
const ZH: Record<string, string> = {
  ...
  'affix_desc.resonance': '范围内共享资源或词条的技能触发时，本技能自动触发N次',
  ...
  'param.resonance': '{rel}共享技能触发时自触发{n}次',
  'param.amplify': '{rel}{icon}{name}每层+1×基础产出',
...
const EN: Record<string, string> = {
  ...
  'affix_desc.resonance': 'Auto-triggers N times when nearby shared-resource or shared-affix skills trigger',
  ...
  'param.resonance': '{rel} shared skill triggers self {n}×',
  'param.amplify': '{rel}{icon}{name} per stack +1× base',
