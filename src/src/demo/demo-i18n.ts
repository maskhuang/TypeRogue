...
const ZH: Record<string, string> = {
  ...
  'ench_meta.apprentice_res_base.desc': '产出基数资源时按产量永久成长',
  'ench_meta.apprentice_res_score': '专精·分数',
  'ench_meta.apprentice_res_score.desc': '产出分数资源时按产量永久成长',
  'ench_meta.apprentice_res_multiplier': '专精·倍率',
  'ench_meta.apprentice_res_multiplier.desc': '产出倍率资源时按产量永久成长',
  'ench_meta.apprentice_res_time': '专精·时间',
  'ench_meta.apprentice_res_time.desc': '产出时间资源时按产量永久成长',
  'ench_meta.apprentice_res_gold': '专精·金币',
  'ench_meta.apprentice_res_gold.desc': '产出金币资源时按产量永久成长',
...
const EN: Record<string, string> = {
  ...
  'ench_meta.apprentice_res_base.desc': 'Perma growth scaled by base output',
  'ench_meta.apprentice_res_score': 'Spec·Score',
  'ench_meta.apprentice_res_score.desc': 'Perma growth scaled by score output',
  'ench_meta.apprentice_res_multiplier': 'Spec·Multiplier',
  'ench_meta.apprentice_res_multiplier.desc': 'Perma growth scaled by multiplier output',
  'ench_meta.apprentice_res_time': 'Spec·Time',
  'ench_meta.apprentice_res_time.desc': 'Perma growth scaled by time output',
  'ench_meta.apprentice_res_gold': 'Spec·Gold',
  'ench_meta.apprentice_res_gold.desc': 'Perma growth scaled by gold output',
