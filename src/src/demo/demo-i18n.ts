...
const ZH: Record<string, string> = {
  ...
  'tutorial.phase5.bind': '新技能需要绑定到键盘上。拖拽技能到键位！',
  'tutorial.phase5.rotate': '多格技能占多个键位。放置前可以右键旋转调整方向！',
...
const EN: Record<string, string> = {
  ...
  'tutorial.phase5.bind': 'New skills need key bindings. Drag to a key!',
  'tutorial.phase5.rotate': 'Multi-cell skills occupy multiple keys. Right-click to rotate before placing!',
