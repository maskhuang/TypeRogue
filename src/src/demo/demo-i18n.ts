...
const ZH: Record<string, string> = {
  ...
  'affix_desc.cluster': '单词中出现连续辅音（如str、ng）越长，产出加成越高',
  'affix_desc.coverage': '单词中用到的不同字母越多，产出加成越高',
  'affix_desc.bigram': '单词中相邻两个字母的组合越少见（如qz），产出越高',
  ...
  'affix_desc.cipher': '单词中相邻字母在字母表中跨度越大（如az、mx），产出越高',
  ...
  'affix_desc.clique': '在指定关系的邻居中，找到彼此也满足该关系的一群技能——这群技能越多，产出越高（如3个技能两两相邻=3人团）',
...
const EN: Record<string, string> = {
  ...
  'affix_desc.cluster': 'Longer consonant sequences in word (e.g. str, ng) = higher bonus',
  'affix_desc.coverage': 'More different letters used in word = higher bonus',
  'affix_desc.bigram': 'Rarer adjacent letter combos in word (e.g. qz) = higher bonus',
  ...
  'affix_desc.cipher': 'Bigger alphabet jumps between adjacent letters (e.g. a→z, m→x) = more output',
  ...
  'affix_desc.clique': 'Find the largest group of neighbors where every pair satisfies the relation (e.g. 3 mutually adjacent keys = 3-clique) — bigger group = more output',
