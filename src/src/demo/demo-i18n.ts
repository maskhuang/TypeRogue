...
const ZH: Record<string, string> = {
  ...
  // Epic 52: 34 新质变
  'quest.quest_resonance': '共振', 'quest.quest_resonance.effect': '质变：双向叠层', 'quest.quest_resonance.task': '装备N个',
  'quest.quest_war_drum': '战号', 'quest.quest_war_drum.effect': '质变：暴击回馈叠层', 'quest.quest_war_drum.task': '装备N个',
  'quest.quest_fallacy': '豪赌', 'quest.quest_fallacy.effect': '质变：减半不归零', 'quest.quest_fallacy.task': '装备N个',
  'quest.quest_phase_shift': '超临界', 'quest.quest_phase_shift.effect': '质变：三态叠加', 'quest.quest_phase_shift.task': '装备N个',
  'quest.quest_endo_exo': '永动', 'quest.quest_endo_exo.effect': '质变：超导爆发', 'quest.quest_endo_exo.task': '装备N个',
  'quest.quest_fusion': '恒星', 'quest.quest_fusion.effect': '质变：阈值递降', 'quest.quest_fusion.task': '装备N个',
  'quest.quest_innate': '觉醒', 'quest.quest_innate.effect': '质变：三连触发', 'quest.quest_innate.task': '装备N个',
  'quest.quest_counter': '反噬', 'quest.quest_counter.effect': '质变：负值转化', 'quest.quest_counter.task': '装备N个',
  'quest.quest_exhaust': '燃尽', 'quest.quest_exhaust.effect': '质变：终结技×3', 'quest.quest_exhaust.task': '装备N个',
  'quest.quest_ethereal': '永恒', 'quest.quest_ethereal.effect': '质变：50%续命', 'quest.quest_ethereal.task': '装备N个',
  'quest.quest_cluster': '塞音', 'quest.quest_cluster.effect': '质变：辅音丛总和', 'quest.quest_cluster.task': '装备N个',
  'quest.quest_coverage': '全谱', 'quest.quest_coverage.effect': '质变：稀有字母加权', 'quest.quest_coverage.task': '装备N个',
  'quest.quest_bigram': '密码', 'quest.quest_bigram.effect': '质变：去掉短板', 'quest.quest_bigram.task': '装备N个',
  'quest.quest_flow': '瀑布', 'quest.quest_flow.effect': '质变：双向落差', 'quest.quest_flow.task': '装备N个',
  'quest.quest_confluence': '洪流', 'quest.quest_confluence.effect': '质变：分流产出', 'quest.quest_confluence.task': '装备N个',
  'quest.quest_turbulence': '风暴', 'quest.quest_turbulence.effect': '质变：双源极差', 'quest.quest_turbulence.task': '装备N个',
  'quest.quest_parity': '相变', 'quest.quest_parity.effect': '质变：奇数自触发', 'quest.quest_parity.task': '装备N个',
  'quest.quest_prime': '近似', 'quest.quest_prime.effect': '质变：非素数加成', 'quest.quest_prime.task': '装备N个',
  'quest.quest_match': '入局', 'quest.quest_match.effect': '质变：自身参与配对', 'quest.quest_match.task': '装备N个',
  'quest.quest_entropy': '熵增', 'quest.quest_entropy.effect': '质变：递增翻倍', 'quest.quest_entropy.task': '装备N个',
  'quest.quest_cipher': '破译', 'quest.quest_cipher.effect': '质变：距离转暴击', 'quest.quest_cipher.task': '装备N个',
  'quest.quest_pattern': '编码', 'quest.quest_pattern.effect': '质变：模式决定资源', 'quest.quest_pattern.task': '装备N个',
  'quest.quest_leverage': '对赌', 'quest.quest_leverage.effect': '质变：亏损转嫁', 'quest.quest_leverage.task': '装备N个',
  'quest.quest_option': '期货', 'quest.quest_option.effect': '质变：权利金累积释放', 'quest.quest_option.task': '装备N个',
  'quest.quest_hedge': '调控', 'quest.quest_hedge.effect': '质变：主动均衡', 'quest.quest_hedge.task': '装备N个',
  'quest.quest_burst': '弹幕', 'quest.quest_burst.effect': '质变：暴击溅射', 'quest.quest_burst.task': '装备N个',
  'quest.quest_zero_in': '蓄能', 'quest.quest_zero_in.effect': '质变：miss转叠层', 'quest.quest_zero_in.task': '装备N个',
  'quest.quest_sharpshooter': '狙击', 'quest.quest_sharpshooter.effect': '质变：双维输出', 'quest.quest_sharpshooter.task': '装备N个',
  'quest.quest_bridge': '枢纽', 'quest.quest_bridge.effect': '质变：中转触发', 'quest.quest_bridge.task': '装备N个',
  'quest.quest_clique': '方阵', 'quest.quest_clique.effect': '质变：团内共享', 'quest.quest_clique.task': '装备N个',
  'quest.quest_component': '网络', 'quest.quest_component.effect': '质变：活跃累积', 'quest.quest_component.task': '装备N个',
  'quest.quest_decorator': '编译', 'quest.quest_decorator.effect': '质变：词条数驱动', 'quest.quest_decorator.task': '装备N个',
  'quest.quest_reflect': '内省', 'quest.quest_reflect.effect': '质变：全词条增幅', 'quest.quest_reflect.task': '装备N个',
  'quest.quest_monkey_patch': '热更新', 'quest.quest_monkey_patch.effect': '质变：全体patch', 'quest.quest_monkey_patch.task': '装备N个',
...
const EN: Record<string, string> = {
  ...
  // Epic 52
  'quest.quest_resonance': 'Resonance', 'quest.quest_resonance.effect': 'Transform: bidirectional stacks', 'quest.quest_resonance.task': 'Equip N',
  'quest.quest_war_drum': 'War Horn', 'quest.quest_war_drum.effect': 'Transform: crit feeds stacks', 'quest.quest_war_drum.task': 'Equip N',
  'quest.quest_fallacy': 'All In', 'quest.quest_fallacy.effect': 'Transform: halve instead of reset', 'quest.quest_fallacy.task': 'Equip N',
  'quest.quest_phase_shift': 'Supercritical', 'quest.quest_phase_shift.effect': 'Transform: all phases stack', 'quest.quest_phase_shift.task': 'Equip N',
  'quest.quest_endo_exo': 'Perpetual', 'quest.quest_endo_exo.effect': 'Transform: superconduct burst', 'quest.quest_endo_exo.task': 'Equip N',
  'quest.quest_fusion': 'Stellar', 'quest.quest_fusion.effect': 'Transform: threshold decays', 'quest.quest_fusion.task': 'Equip N',
  'quest.quest_innate': 'Awakening', 'quest.quest_innate.effect': 'Transform: triple auto-trigger', 'quest.quest_innate.task': 'Equip N',
  'quest.quest_counter': 'Backlash', 'quest.quest_counter.effect': 'Transform: absorb into bonus', 'quest.quest_counter.task': 'Equip N',
  'quest.quest_exhaust': 'Burnout', 'quest.quest_exhaust.effect': 'Transform: final blast ×3', 'quest.quest_exhaust.task': 'Equip N',
  'quest.quest_ethereal': 'Eternal', 'quest.quest_ethereal.effect': 'Transform: 50% survive', 'quest.quest_ethereal.task': 'Equip N',
  'quest.quest_cluster': 'Plosive', 'quest.quest_cluster.effect': 'Transform: sum all clusters', 'quest.quest_cluster.task': 'Equip N',
  'quest.quest_coverage': 'Full Spectrum', 'quest.quest_coverage.effect': 'Transform: rare letters ×2', 'quest.quest_coverage.task': 'Equip N',
  'quest.quest_bigram': 'Cipher', 'quest.quest_bigram.effect': 'Transform: drop bottom half', 'quest.quest_bigram.task': 'Equip N',
  'quest.quest_flow': 'Waterfall', 'quest.quest_flow.effect': 'Transform: bidirectional flow', 'quest.quest_flow.task': 'Equip N',
  'quest.quest_confluence': 'Torrent', 'quest.quest_confluence.effect': 'Transform: split output', 'quest.quest_confluence.task': 'Equip N',
  'quest.quest_turbulence': 'Storm', 'quest.quest_turbulence.effect': 'Transform: dual dispersion', 'quest.quest_turbulence.task': 'Equip N',
  'quest.quest_parity': 'Phase', 'quest.quest_parity.effect': 'Transform: odd self-trigger', 'quest.quest_parity.task': 'Equip N',
  'quest.quest_prime': 'Approx', 'quest.quest_prime.effect': 'Transform: composite bonus', 'quest.quest_prime.task': 'Equip N',
  'quest.quest_match': 'Join', 'quest.quest_match.effect': 'Transform: self joins pairs', 'quest.quest_match.task': 'Equip N',
  'quest.quest_entropy': 'Entropy+', 'quest.quest_entropy.effect': 'Transform: rising doubles', 'quest.quest_entropy.task': 'Equip N',
  'quest.quest_cipher': 'Decode', 'quest.quest_cipher.effect': 'Transform: distance→crit', 'quest.quest_cipher.task': 'Equip N',
  'quest.quest_pattern': 'Encode', 'quest.quest_pattern.effect': 'Transform: pattern→resource', 'quest.quest_pattern.task': 'Equip N',
  'quest.quest_leverage': 'Gamble', 'quest.quest_leverage.effect': 'Transform: losses to neighbors', 'quest.quest_leverage.task': 'Equip N',
  'quest.quest_option': 'Futures', 'quest.quest_option.effect': 'Transform: accumulate premium', 'quest.quest_option.task': 'Equip N',
  'quest.quest_hedge': 'Regulate', 'quest.quest_hedge.effect': 'Transform: active balancing', 'quest.quest_hedge.task': 'Equip N',
  'quest.quest_burst': 'Barrage', 'quest.quest_burst.effect': 'Transform: crit splash', 'quest.quest_burst.task': 'Equip N',
  'quest.quest_zero_in': 'Charge Up', 'quest.quest_zero_in.effect': 'Transform: miss→stacks', 'quest.quest_zero_in.task': 'Equip N',
  'quest.quest_sharpshooter': 'Snipe', 'quest.quest_sharpshooter.effect': 'Transform: dual output', 'quest.quest_sharpshooter.task': 'Equip N',
  'quest.quest_bridge': 'Hub', 'quest.quest_bridge.effect': 'Transform: bridge triggers sides', 'quest.quest_bridge.task': 'Equip N',
  'quest.quest_clique': 'Formation', 'quest.quest_clique.effect': 'Transform: clique shares bonus', 'quest.quest_clique.task': 'Equip N',
  'quest.quest_component': 'Network', 'quest.quest_component.effect': 'Transform: activity accumulates', 'quest.quest_component.task': 'Equip N',
  'quest.quest_decorator': 'Compile', 'quest.quest_decorator.effect': 'Transform: affix-count driven', 'quest.quest_decorator.task': 'Equip N',
  'quest.quest_reflect': 'Introspect', 'quest.quest_reflect.effect': 'Transform: boost all affixes', 'quest.quest_reflect.task': 'Equip N',
  'quest.quest_monkey_patch': 'Hot Fix', 'quest.quest_monkey_patch.effect': 'Transform: patch all affixes', 'quest.quest_monkey_patch.task': 'Equip N',
