...
const ZH: Record<string, string> = {
  ...
  'affix_desc.relay': '自身不产出；指定关系的匹配技能触发时叠层，每叠N层中转触发1个匹配技能',
  ...
  'quest.quest_relay': '中继', 'quest.quest_relay.effect': '中转时触发所有匹配技能', 'quest.quest_relay.task': '装备N个',
  ...
  'param.relay': '{rel}每{n}层中转触发1个匹配技能',
...
const EN: Record<string, string> = {
  ...
  'param.innate': 'auto-trigger at start',
