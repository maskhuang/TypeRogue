...
const ZH: Record<string, string> = {
  ...
  'affix_desc.pulse': '满层时立刻自触发一次',
  'affix_desc.crit': '触发时有概率暴击',
  'affix_desc.cascade': '上一个按键与当前键为指定关系时，产出倍增',
  'affix_desc.void': '指定关系的空位越多加成越高',
  'affix_desc.resonance': '指定关系的匹配技能触发时也+1层，满层自触发一次',
  'affix_desc.mirror': '每关结束时从指定关系的邻居中随机复制一个词条，下关替代自身生效',
  'affix_desc.splash': '自身不产出；满层时触发指定关系的1个匹配技能',
  'affix_desc.amplify': '自身不产出；指定关系的匹配技能产出+自身基础值×层数',
  'affix_desc.conduit': '自身不产出，指定关系的匹配技能触发时额外触发一次',
  'affix_desc.relay': '自身不产出；指定关系的匹配技能触发时也+1层，满层触发1个匹配技能',
  ...
  'affix_desc.war_drum': '自身不产出；指定关系的匹配技能暴击率+层数相关加成',
...
const EN: Record<string, string> = {
  ...
  'affix_desc.pulse': 'Self-triggers once when stacks are full',
