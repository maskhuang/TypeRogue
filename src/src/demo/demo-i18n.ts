...
const ZH: Record<string, string> = {
  ...
  'affix_desc.cluster': '单词中连续辅音越长，产出加成越高',
  'affix_desc.coverage': '单词中用到的不同字母越多，产出加成越高',
  'affix_desc.bigram': '单词中相邻两个字母的组合越少见，产出越高',
  ...
  'affix_desc.entropy': '单词中每个字母出现次数越接近，产出越高',
  'affix_desc.cipher': '单词中相邻字母在字母表中跨度越大，产出越高',
  'affix_desc.pattern': '单词的字母重复规律越罕见，产出越高',
  ...
  'est.cluster': '连续辅音(如str) +{pct}%',
  'est.coverage': '覆盖度 +{pct}%',
  'est.bigram': '罕见字母对(如qz) +{pct}%',
  'est.entropy_est': '字母均匀度(abcde>aaabb) +{pct}%',
  'est.cipher': '字母跳跃(如a→z) +{pct}%',
  'est.pattern': '罕见规律(abcabc>aabbcc) +{pct}%',
...
const EN: Record<string, string> = {
  ...
  'affix_desc.cluster': 'Longer consonant sequences in word = higher bonus',
  'affix_desc.coverage': 'More different letters used in word = higher bonus',
  'affix_desc.bigram': 'Rarer adjacent letter combos in word = higher bonus',
  ...
  'affix_desc.entropy': 'Each letter appears roughly equal times in word = more output',
  'affix_desc.cipher': 'Bigger alphabet jumps between adjacent letters = more output',
  'affix_desc.pattern': 'Rarer letter repetition structure = more output',
  ...
  'est.cluster': 'Consonants(str,ng) +{pct}%',
  'est.coverage': 'Coverage +{pct}%',
  'est.bigram': 'Rare pairs(qz) +{pct}%',
  'est.entropy_est': 'Uniformity(abcde>aaabb) +{pct}%',
  'est.cipher': 'Letter jump(a→z) +{pct}%',
  'est.pattern': 'Rare pattern(abcabc>aabbcc) +{pct}%',
