...
const ZH: Record<string, string> = {
  ...
  'affix_desc.clique': '把满足指定关系的技能紧密聚在一起——不仅要和我相连，彼此之间也要相连；这样的群组越大，产出越高',
...
const EN: Record<string, string> = {
  ...
  'affix_desc.clique': 'Pack skills tightly — they must satisfy the relation not just with you but with each other too; the larger such a group, the more output',
