...
const ZH: Record<string, string> = {
  ...
  // === 通用 err ===
  'shop.terminal.err.not_found': '错误 · 未找到：{target}',
  'shop.terminal.err.skill_missing': '错误 · 技能定义缺失 · {sid}',
  'shop.terminal.err.relic_missing': '错误 · 遗物定义缺失 · {rid}',
  'shop.terminal.err.insufficient_funds': '错误 · 余额不足 · 余额 🍌 {gold} · 需要 🍌 {price}',
  'shop.terminal.err.purchase_not_wired': '错误 · {kind} 购买尚未接入',
  'shop.terminal.err.intray_full': '错误 · 收件托盘已满 ({n}/{max}) · 上呈工作台后再采购',
  'shop.terminal.err.no_skill_data': '错误 · 商品无技能数据 · 无法采购',
  'shop.terminal.err.pack_no_words': '错误 · 词包无内容 · 无法采购',
  'shop.terminal.err.drawer_open': '错误 · 抽屉 {kind} 处开启 · 请先关闭 [ESC]',
  'shop.terminal.err.relic_no_id': '错误 · 遗物无编号 · 无法采购',
  'shop.terminal.err.relic_owned': '错误 · 遗物已持有 · {rid}',
  'shop.terminal.err.relic_slots_full': '错误 · 数字行槽位已满 · 请先废置一项',
  'shop.terminal.err.relic_add_failed': '错误 · 遗物入库失败 · 请联系档案室',
  'shop.terminal.err.sku_not_in_catalog': '错误 · 库存目录无此货号：{sku}',
  'shop.terminal.err.clearance_required': '错误 · 需要 {clearance} 级权限 · 请联系上级',
  'shop.terminal.err.not_in_intray': '错误 · {target} 不在收件托盘',
  'shop.terminal.err.sell_not_skill': '错误 · 终端仅可出售收件托盘内技能',
  'shop.terminal.err.reshuffle_funds': '错误 · 余额不足 · 需要 🍌 {cost}',
  'shop.terminal.err.reshuffle_unavailable': '错误 · 生成器不可用 · 🍌 {cost} 已退还 · 请重试',
  'shop.terminal.err.confirm_yn': '错误 · 预期 [Y]ES 或 [N]O · 收到 "{input}" · 请重试',
  'shop.terminal.err.unknown_verb': '错误 · 未知动词：{verb}',
  // === cmdInfo / OWNED ===
