...
const ZH: Record<string, string> = {
  ...
  'affix_desc.clique': '自身与指定关系的邻居中互相都满足该关系的最大群组越大，产出越高',
...
const EN: Record<string, string> = {
  ...
  'affix_desc.clique': 'Larger group of neighbors that all satisfy the relation with each other = more output',
