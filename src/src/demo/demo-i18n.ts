...
const ZH: Record<string, string> = {
  ...
  'affix.outcast': '退场', 'affix.gravity': '引力', 'affix.ligature': '连字',
  'affix.war_drum': '战鼓',
  'affix.twin': '双生', 'affix.recurse': '递归', 'affix.taboo': '禁忌', 'affix.fallacy': '赌徒',
  'affix.phase_shift': '相变', 'affix.endo_exo': '吸放热', 'affix.fusion': '聚变',
  'affix.flow': '落差', 'affix.confluence': '汇流', 'affix.union': '联合', 'affix.turbulence': '湍流',
  ...
  'affix.decorator': '装饰器', 'affix.reflect': '反射', 'affix.monkey_patch': '猴子补丁', 'affix.excavate': '挖掘', 'affix.treasure': '寻宝', 'affix.refine': '提纯', 'affix.evolve': '进化', 'affix.harvest': '收割', 'affix.chain': '连锁', 'affix.volatile': '不稳定', 'affix.mutacrit': '蜕变暴击', 'affix.ascend': '升华', 'affix.reecho': '回音', 'affix.myopia': '短视', 'affix.silkworm': '蚕食', 'affix.repulsion': '斥力',
  'affix.aura_fury': '愤怒光环', 'affix.aura_morale': '士气光环', 'affix.fiber': '光纤', 'affix.proofread': '校勘', 'affix.spelling': '拼写', 'affix.first_edition': '初版', 'affix.reprint': '再版', 'affix.matrix': '字模', 'affix.typeset': '排版',
...
const EN: Record<string, string> = {
  ...
  'affix.outcast': 'Curtain', 'affix.gravity': 'Gravity', 'affix.ligature': 'Ligature',
  ...
  'affix.decorator': 'Decorator', 'affix.reflect': 'Reflect', 'affix.monkey_patch': 'Monkey Patch', 'affix.excavate': 'Excavate', 'affix.treasure': 'Treasure', 'affix.refine': 'Refine', 'affix.evolve': 'Evolve', 'affix.harvest': 'Harvest', 'affix.chain': 'Chain', 'affix.volatile': 'Volatile', 'affix.mutacrit': 'Mutacrit', 'affix.ascend': 'Ascend', 'affix.reecho': 'Re-echo', 'affix.myopia': 'Myopia', 'affix.silkworm': 'Silkworm', 'affix.repulsion': 'Repulsion',
  'affix.aura_fury': 'Fury Aura', 'affix.aura_morale': 'Morale Aura', 'affix.fiber': 'Fiber', 'affix.proofread': 'Proofread', 'affix.spelling': 'Spelling', 'affix.first_edition': 'First Edition', 'affix.reprint': 'Reprint', 'affix.matrix': 'Matrix', 'affix.typeset': 'Typeset',
