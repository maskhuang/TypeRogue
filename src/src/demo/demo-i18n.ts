...
const ZH: Record<string, string> = {
  ...
  'affix_desc.counter': '自身或相邻技能产出为负时消耗充能取消（每关恢复充能）',
...
const EN: Record<string, string> = {
  ...
  'affix_desc.counter': 'When self or adjacent skill outputs negative, spend charge to cancel (recharges each stage)',
