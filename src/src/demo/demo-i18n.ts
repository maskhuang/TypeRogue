...
const ZH: Record<string, string> = {
  ...
  // --- quest enchantments (18 name + 18 effect) ---
  'quest.quest_devour': '吞噬', 'quest.quest_devour.effect': '每空位加成 +5%',
  'quest.quest_overload': '过载', 'quest.quest_overload.effect': '质变：保底暴击',
  'quest.quest_echo': '回响', 'quest.quest_echo.effect': '质变：跨技能脉冲同步',
  'quest.quest_chain': '连锁', 'quest.quest_chain.effect': '级联倍率 +0.2',
  'quest.quest_purify': '净化', 'quest.quest_purify.effect': '质变：衰减反转为增长',
  'quest.quest_resonance': '共振', 'quest.quest_resonance.effect': '触发产出 +10%/层',
  'quest.quest_charge': '蓄势', 'quest.quest_charge.effect': '加成 +15%',
  'quest.quest_refine': '精炼', 'quest.quest_refine.effect': '转化系数 ×1.1',
  ...
  'quest.quest_polarize': '极化', 'quest.quest_polarize.effect': '概率偏移 +0.15',
  'quest.quest_spectrum': '光谱', 'quest.quest_spectrum.effect': '随机权重偏向最低资源 +15%/层',
...
const EN: Record<string, string> = {
  ...
  // --- quest enchantments (18 name + 18 effect) ---
  'quest.quest_devour': 'Devour', 'quest.quest_devour.effect': 'Empty slot bonus +5%',
  ...
  'quest.quest_chain': 'Chain', 'quest.quest_chain.effect': 'Cascade mult +0.2',
  'quest.quest_purify': 'Purify', 'quest.quest_purify.effect': 'Transform: decay reverses to growth',
  'quest.quest_resonance': 'Harmonize', 'quest.quest_resonance.effect': 'Trigger output +10%/stack',
  'quest.quest_charge': 'Empower', 'quest.quest_charge.effect': 'Bonus +15%',
  'quest.quest_refine': 'Refine', 'quest.quest_refine.effect': 'Convert coeff ×1.1',
  ...
  'quest.quest_polarize': 'Polarize', 'quest.quest_polarize.effect': 'Prob shift +0.15',
  'quest.quest_spectrum': 'Spectrum', 'quest.quest_spectrum.effect': 'Random weight toward lowest resource +15%/stack',
