...
const ZH: Record<string, string> = {
  ...
  'affix_desc.mirror': '每关开始时复制一个范围内技能的随机词条',
  ...
  'param.splash_res': '{rel}溅射{name}技能',
  'param.splash_affix': '{rel}溅射[{affix}]技能',
  'param.splash_default': '{rel}溅射触发',
  'param.ligature': '连字加成',
  'param.twin': '双附魔',
...
const EN: Record<string, string> = {
  ...
  'affix_desc.mirror': 'Copies a random affix from a nearby skill at stage start',
  ...
  'param.splash_res': '{rel} splash {name} skills',
  'param.splash_affix': '{rel} splash [{affix}] skills',
  'param.splash_default': '{rel} splash trigger',
