...
const ITEM_NAMES_EN: Record<string, string> = {
  ...
  gene_stabilizer: 'Gene Stabilizer', catalyst_injector: 'Catalyst Injector',
  chaos_seed: 'Chaos Seed', abyss_eye: 'Abyss Eye',
  fittest_survivors: 'Fittest Survivors', masters_lexicon: "Master's Lexicon",
  perpetual_queue: 'Perpetual Queue', refining_lens: 'Refining Lens',
  word_scissors: 'Word Scissors', resonance_mold: 'Resonance Mold',
  fragment_prism: 'Fragment Prism',
  // Enchantments — Growth
...
const ITEM_DESCS_EN: Record<string, string> = {
  ...
  gene_stabilizer: 'Re-metamorphing same key is free this stage',
  catalyst_injector: 'Mutagen→resource converter output +30%',
  chaos_seed: 'Random unenchanted skill gets enchanted each stage',
  abyss_eye: 'Preview 2 hidden pool skills at metamorph station',
  ...
  refining_lens: 'Fragment→resource converter output +30%',
  word_scissors: 'Disassemble crafted words, refund 50% fragments',
  resonance_mold: 'Duplicate letters cost no gold when crafting',
  fragment_prism: 'Each harvest slot also produces adjacent letter fragments',
  // Enchantments — Growth
