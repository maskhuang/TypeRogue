...
const ZH: Record<string, string> = {
  ...
  'ench_meta.apprentice_res_gold': '专精·香蕉',
  ...
  'quest.quest_charge': '谢幕', 'quest.quest_charge.effect': '暴击时触发词首字母键技能', 'quest.quest_charge.task': '装备N个',
  ...
  'quest.quest_polarize': '潮汐锁定', 'quest.quest_polarize.effect': '含本键字母的单词必定出现', 'quest.quest_polarize.task': '装备N个',
  ...
  'quest.quest_splash': '连锁溅射', 'quest.quest_splash.effect': '二次溅射', 'quest.quest_splash.task': '装备N个',
  'quest.quest_fury': '狂暴', 'quest.quest_fury.effect': '自触发+全场暴击率', 'quest.quest_fury.task': '装备N个',
  'quest.quest_tide': '涨潮', 'quest.quest_tide.effect': '连击加速叠层', 'quest.quest_tide.task': '装备N个',
  'quest.quest_resonance': '谐振', 'quest.quest_resonance.effect': '商店保底同资源技能', 'quest.quest_resonance.task': '装备N个',
  'quest.quest_echo': '共鸣腔', 'quest.quest_echo.effect': '商店保底含监听词条技能', 'quest.quest_echo.task': '装备N个',
  'quest.quest_union': '集结', 'quest.quest_union.effect': '商店保底匹配技能', 'quest.quest_union.task': '装备N个',
  ...
  'quest.quest_harvest': '丰收', 'quest.quest_harvest.effect': '被蜕变时获得250香蕉', 'quest.quest_harvest.task': '装备N个',
  ...
  'quest.quest_swarm_propagate': '繁殖', 'quest.quest_swarm_propagate.effect': '触发时25%概率向全场随机无虫群技能传播虫群词条', 'quest.quest_swarm_propagate.task': '装备N个',
  'quest.quest_mercenary_warlord': '佣兵王', 'quest.quest_mercenary_warlord.effect': '加成按香蕉存量缩放', 'quest.quest_mercenary_warlord.task': '装备N个',
  'quest.quest_repulsion_vacuum': '真空', 'quest.quest_repulsion_vacuum.effect': '含本键字母的单词必不出现', 'quest.quest_repulsion_vacuum.task': '装备N个',
  'quest.quest_silkworm_cocoon': '化茧', 'quest.quest_silkworm_cocoon.effect': '累积8层后本关不再消耗底分', 'quest.quest_silkworm_cocoon.task': '装备N个',
  ...
  'quest.quest_fiber_pierce': '贯穿', 'quest.quest_fiber_pierce.effect': '满层触发单词中所有字母键技能（排除首字母）', 'quest.quest_fiber_pierce.task': '装备N个',
...
const EN: Record<string, string> = {
  ...
  'ench_meta.apprentice_res_gold': 'Spec·Banana',
  ...
  'quest.quest_charge': 'Curtain Call', 'quest.quest_charge.effect': 'On crit, trigger skill on the word\'s first letter key', 'quest.quest_charge.task': 'Equip N',
  ...
  'quest.quest_polarize': 'Tidal Lock', 'quest.quest_polarize.effect': 'Words with this key\'s letter always appear', 'quest.quest_polarize.task': 'Equip N',
  ...
  'quest.quest_splash': 'Chain Splash', 'quest.quest_splash.effect': 'Splash targets trigger 1 more', 'quest.quest_splash.task': 'Equip N',
  'quest.quest_fury': 'Rampage', 'quest.quest_fury.effect': 'Self-trigger +20% crit all', 'quest.quest_fury.task': 'Equip N',
  'quest.quest_tide': 'Surge', 'quest.quest_tide.effect': 'Rate scales with combo', 'quest.quest_tide.task': 'Equip N',
  'quest.quest_resonance': 'Harmonize', 'quest.quest_resonance.effect': 'Shop guarantees same-resource skill', 'quest.quest_resonance.task': 'Equip N',
  'quest.quest_echo': 'Resonator', 'quest.quest_echo.effect': 'Shop guarantees skill with watched affix', 'quest.quest_echo.task': 'Equip N',
  'quest.quest_union': 'Rally', 'quest.quest_union.effect': 'Shop guarantees matched skill', 'quest.quest_union.task': 'Equip N',
  ...
  'quest.quest_harvest': 'Bounty', 'quest.quest_harvest.effect': 'Mutation grants 250 banana', 'quest.quest_harvest.task': 'Equip N',
  ...
  'quest.quest_swarm_propagate': 'Propagate', 'quest.quest_swarm_propagate.effect': '25% chance to spread Swarm to any random Swarm-less skill on trigger', 'quest.quest_swarm_propagate.task': 'Equip N',
  'quest.quest_mercenary_warlord': 'Warlord', 'quest.quest_mercenary_warlord.effect': 'Bonus scales with banana reserves', 'quest.quest_mercenary_warlord.task': 'Equip N',
  'quest.quest_repulsion_vacuum': 'Vacuum', 'quest.quest_repulsion_vacuum.effect': 'Words with this key\'s letter never appear', 'quest.quest_repulsion_vacuum.task': 'Equip N',
  'quest.quest_silkworm_cocoon': 'Cocoon', 'quest.quest_silkworm_cocoon.effect': 'After 8 stacks, stage no longer consumes base', 'quest.quest_silkworm_cocoon.task': 'Equip N',
  ...
  'quest.quest_fiber_pierce': 'Pierce', 'quest.quest_fiber_pierce.effect': 'When full, trigger all letter keys in word (except first)', 'quest.quest_fiber_pierce.task': 'Equip N',
