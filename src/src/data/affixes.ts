...
export const AFFIX_CATEGORY_MAP: Record<AffixType, AffixCategory[]> = {
  ...
  [AffixType.Overflow]: ['crit', 'topology'],
  // ── 叠层型 ──
  [AffixType.Pulse]: ['stack', 'topology'],
  [AffixType.Resonance]: ['stack', 'topology'],
  ...
  [AffixType.Parity]: ['stack', 'crit', 'numeric'],
  [AffixType.Prime]: ['stack', 'numeric'],
  ...
  [AffixType.Clique]: ['topology', 'crit'],
  [AffixType.Component]: ['topology', 'stack'],
  // ── 词感型 ──
  [AffixType.Outcast]: ['word_sense', 'stack'],
  [AffixType.Gravity]: ['word_sense'],
  [AffixType.Ligature]: ['word_sense', 'numeric'],
  [AffixType.Cluster]: ['word_sense', 'stack'],
  [AffixType.Coverage]: ['word_sense', 'numeric'],
  [AffixType.Bigram]: ['word_sense', 'crit'],
  [AffixType.Entropy]: ['word_sense', 'numeric'],
  [AffixType.Cipher]: ['word_sense', 'crit'],
  [AffixType.Pattern]: ['word_sense', 'numeric'],
  // ── 元规则型 ──
  [AffixType.Conduit]: ['meta_rule', 'topology'],
  [AffixType.Twin]: ['meta_rule'],
  [AffixType.Innate]: ['meta_rule'],
  [AffixType.Counter]: ['meta_rule', 'topology', 'numeric'],
...
export const QUEST_AFFIX_MAP: Partial<Record<EnchantmentType, AffixType | AffixType[]>> = {
  ...
  [EnchantmentType.QuestOverflow]: AffixType.Overflow,
...
export const QUEST_ENCHANTMENT_DEFS: QuestEnchantmentDef[] = [
  ...
  { type: EnchantmentType.QuestCipher, name: '破译', targetAffix: AffixType.Cipher, event: 'equip_count', targetStacks: 0, effectDesc: '质变：距离爆破', transformDesc: '暴击时最大字母跳跃距离额外加到暴击倍率' },
