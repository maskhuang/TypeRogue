...
export const AFFIX_DESCRIPTIONS: Record<AffixType, string> = {
  ...
  [AffixType.Resonance]: '相邻技能触发时，本技能以指定效率被动触发',
  [AffixType.Mirror]: '每关开始时复制一个相邻技能的随机词条',
  [AffixType.Link]: '相邻技能产出指定资源时，本技能自动触发',
  [AffixType.Replicate]: '按键时同时触发相邻技能',
  [AffixType.Amplify]: '每次触发叠一层，与相邻同资源增幅技能共享层数加成',
