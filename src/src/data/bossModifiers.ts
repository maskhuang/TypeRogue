 ...
 *
 * 数据来源：data-json/bossModifiers.json，由 schemas/bossModifiers.schema.ts 校验加载（Story 57.1）
 */
import { BOSS_MODIFIERS_DATA } from './schemas/bossModifiers.schema'

export const BOSS_MODIFIER_META: Record<BossModifierId, BossModifierMeta> =
  BOSS_MODIFIERS_DATA.meta as Record<BossModifierId, BossModifierMeta>
