...
describe('AffixType', () => {
  ...
  it('should have exactly 38 values', () => {
    expect(allAffixTypes).toHaveLength(38)
  })
  ...
  it('should contain all expected types', () => {
    const expected = [
      ...
      'pulse', 'resonance', 'splash', 'amplify', 'relay', 'war_drum', 'parity', 'prime',
