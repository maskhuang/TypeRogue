...
export const HANDBOOKS = {
  ...
  "meta": {
    "schema_version": "v3.1",
    "q4_decision": "moderate",
    "q5_decision": "three_layer",
    "g_decision": "hand_v1_pep_ai_v2_v3",
    "h_decision": "hr_email_plus_desktop_note",
    "i_decision": "v1_must_v1_pep_others_best_effort",
    "notes": [
